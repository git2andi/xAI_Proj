...
parser.add_argument('--model_name', type=str, default="Alex_7",
...
class AlexNetBatchNorm(nn.Module):
    def __init__(self, num_classes):
        ...
        # Extract the features of the pre-trained AlexNet
        ...
        self.avgpool = nn.AdaptiveAvgPool2d((6, 6))  # AlexNet has different output size
...
# Instantiate the modified AlexNet model with Batch Normalization
model = AlexNetBatchNorm(num_classes=num_classes)
model.to(device)
